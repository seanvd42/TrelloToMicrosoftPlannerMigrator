...
namespace TrelloToMicrosoftPlannerMigrator
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IListMigrationService, ListMigrationService>();
            services.AddScoped<ICardMigrationService, CardMigrationService>();
            services.AddScoped<ICommentMigrationService, CommentMigrationService>();
            services.AddScoped<IChecklistMigrationService, ChecklistMigrationService>();
            services.AddScoped<ILabelMigrationService, LabelMigrationService>();
